$(document).ready(function () {
    $(window).scroll(function (event) {
        ...
        $('.parallax__fog').css('transform', 'translate3d(0, 60px, 0) scale(' + z_1 + ')');
        ...
        $('.parallax__montain2').css('transform', 'translate3d(' + hr + 'px, 60px, 0) scale(' + z_3 + ')');

        //левая гора 1500, 0.00001
        var hr2 = w / 1500 * p_b;
        var z_4 = 1 + (w * 0.00002 * p_b);
        $('.parallax__montain3').css('transform', 'translate3d(' + hr2 + 'px, 60px, 0) scale(' + z_4 + ')');
    });
});